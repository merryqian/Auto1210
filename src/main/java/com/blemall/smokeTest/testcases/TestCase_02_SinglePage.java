...
public void goodName(Map<String, String> param) throws IOException {
	...
	try {
		if (el.isDisplayed()) {
			Log.logError("页面加载失败：" + sp.getElement("H5Load").getText());
			screen.snapshot((TakesScreenshot) driver, timeString, "Single","goodName","单品页加载失败");
			Assert.fail("页面加载失败");
	...
	if (sp.getElement("SinglePageLoad").isDisplayed()) {
		...
		Log.logError("加载失败了，请查看截图查找原因");
		screen.snapshot((TakesScreenshot) driver, timeString, "Single","goodName","普通商品单品页商品名称检查");
		Assert.fail("加载失败");
	}
...
public void goodPrice(Map<String, String> param) throws IOException {
	...
	try {
		if (el.isDisplayed()) {
			Log.logError("页面加载失败：" + sp.getElement("H5Load").getText());
			screen.snapshot((TakesScreenshot) driver, timeString, "Single","goodPrice","单品页加载失败");
			Assert.fail("页面加载失败");
		}
	} catch (Exception e) {
		Log.logInfo("H5页面加载成功");
	...
	if (sp.getElement("SinglePageLoad").isDisplayed()) {
		...
		Log.logError("加载失败了，请查看截图查找原因");
		screen.snapshot((TakesScreenshot) driver, timeString, "Single","goodPrice","普通商品单品页价格显示 测试失败");
...
public void goodNoEvaluate(Map<String, String> param) throws IOException {
	...
	try {
		if (el.isDisplayed()) {
			Log.logError("页面加载失败：" + sp.getElement("H5Load").getText());
			screen.snapshot((TakesScreenshot) driver, timeString, "Single","goodNoEvaluate","单品页加载失败");
			Assert.fail("页面加载失败");
...
public void goodEvaluate(Map<String, String> param) throws IOException {
	...
	try {
		if (el.isDisplayed()) {
			Log.logError("页面加载失败：" + sp.getElement("H5Load").getText());
			screen.snapshot((TakesScreenshot) driver, timeString, "Single","goodEvaluate","单品页加载失败");
			Assert.fail("页面加载失败");
	 ...
	 if (sp.getElement("SinglePageLoad").isDisplayed()) {
		...
		Log.logError("加载失败了，请查看截图查找原因");
		screen.snapshot((TakesScreenshot) driver, timeString, "Single","goodEvaluate","单品页商品有评价记录");
...
public void goodPromotion(Map<String, String> param) throws IOException {
	...
	try {
		if (el.isDisplayed()) {
			Log.logError("页面加载失败：" + sp.getElement("H5Load").getText());
			screen.snapshot((TakesScreenshot) driver, timeString, "goodPromotion","Single",
					"单品页加载");
			Assert.fail("页面加载失败");
		}
	} catch (Exception e) {
...
public void returnOrChangeGoodsNotSupported(Map<String, String> param)
	...
	try {
		if (el.isDisplayed()) {
			Log.logError("页面加载失败：" + sp.getElement("H5Load").getText());
			screen.snapshot((TakesScreenshot) driver, timeString, "Single",
					"returnOrChangeGoodsNotSupported","单品页加载");
			Assert.fail("页面加载失败");
		}
	} catch (Exception e) {
		Log.logInfo("H5页面加载成功");
	...
	if (sp.getElement("SinglePageLoad").isDisplayed()) {
		WebElement scrollView = sp.getElementNoWait("GoodName");
		this.getIntoView(scrollView);
		WebElement suplier = sp.getElement("ReturnOrChangeGoods");
		if (suplier.isDisplayed()) {
...
public void goodDetails(Map<String, String> param) throws IOException {
	...
	if (sp.getElement("SinglePageLoad").isDisplayed()) {
		...
		if (goodDetails.isDisplayed()) {
			...
			screen.snapshot((TakesScreenshot) driver, timeString, "Single",
					"goodDetails","单品页商品详情选择检查-通过");
			Assert.assertTrue(true);   
		}else{
			Log.logInfo("单品页的商品详情按钮显示异常，请查看");
			screen.snapshot((TakesScreenshot) driver, timeString, "Single",
					"goodDetails","单品页商品详情选择检查-失败");
		}
...
//				{
			int i=3;		
			 goods=driver.findElement(By.xpath(".//*[@id='scroller']/div[10]/div/ul/li['+i+']/div/div[2]/a"));
				    Log.logInfo("热门推荐商品= "+i+goods.getText());
				    Log.logInfo(goods);
				//}
				screen.snapshot((TakesScreenshot) driver, timeString, "Single",
